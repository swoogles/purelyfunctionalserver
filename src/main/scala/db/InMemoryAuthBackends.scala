...
object InMemoryAuthBackends {
  val bearerTokenStoreThatShouldBeInstantiatedOnceByTheServer: BackingStore[Task, SecureRandomId, TSecBearerToken[Int]] =
    dummyBackingStore[Task, SecureRandomId, TSecBearerToken[Int]](tokenValue => {// This function is: Int => SecureRandomId
